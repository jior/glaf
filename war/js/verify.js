...
================================================================================
	功能: 限制字符串长度
	参数: minLen 最小长度, maxLen 最大长度(0代表没有限制)
	返回值: boolean
================================================================================
*/
function LenB(str){
...
================================================================================
 * 判断日期是否在指定日期的未来几天内.
 * @param Date appDate 开始日期.
 * @param Date futDate 结束日期.
 * @param int mixDays	至少天数.
...
/**
 * 判断日期是否在指定日期的未来几天内.
 * @param Date appDate 参考日期.
 * @param Date futDate 输入日期.
 * @param int days	天数.
 */
...
*校验两个日期的先后
*返回值：
*如果其中有一个日期为空，校验通过,          返回false
*如果起始日期早于终止日期，校验通过，   返回true
...
sfFocus = function(sfEls) {
	for (var i=0; i<sfEls.length; i++) {
		sfEls[i].onfocus=function() {
			...
			/*if(this.component=="currency"){//货币类型
			  parseNum(this);
			}*/
		}
