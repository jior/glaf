...
<center>
  ...
  <center>
    <span class="subject">
	<img src="<%=request.getContextPath()%>/workflow/images/title.gif" alt="选择用户"> 
	选择用户
	</span>
</center>
<form name="typeForm" method="post" action="actorController.jspa">
<input type="hidden" name="method" value="saveAgents" >
<input type="hidden" name="objectIds" >
<input type="hidden" name="actorId"  value="<c:out value="${actorId}"/>">
<input type="hidden" name="objectId"  value="<c:out value="${objectId}"/>">
<input type="hidden" name="objectValue"  value="<c:out value="${objectValue}"/>">
...
<table class="table-border" align="center" cellpadding="4" cellspacing="1" width="90%">
      ...
      <tr>
        ...
        <td class="table-content" height="26" valign="top" width="290">
          <div align="center">
        ...
        <td class="table-content" height="26" valign="top" width="259">
          <div align="center">
            <select class="list" style="width: 250px; height: 280px;" 
