...
<form name="GenericForm" method="post" action="save.jsp" onsubmit="return checkForm(this);">
    ...
    <td class="box-mm">
      ...
      <tr>
		...
		<input name="title" type="text" size="30" class="input" 
		           value="<c:out value="${todo.title}"/>" datatype="string" nullable="no" minsize="6" maxsize="50" chname="标  题">
		</td>
      </tr>
      <tr>
        ...
        <td>
          <input name="content" type="text" size="30" class="input" datatype="string" 
		             value="<c:out value="${todo.content}"/>" nullable="no" maxsize="255" chname="内容"> </td>
      </tr>
      <tr>
        <td class="input-box2" valign="top">期&nbsp;&nbsp;限*</td>
        <td>
          <input name="limitDay" type="text" size="30" class="input" datatype="int" 
		             value="<c:out value="${todo.limitDay}"/>" nullable="no" maxsize="2" chname="期限"> 天
		  </td>
      </tr>
	  <tr>
        ...
        <td>
          <input name="xa" type="text" size="30" class="input" datatype="int" 
		             value="<c:out value="${todo.xa}"/>" nullable="no" maxsize="3" chname="a"> 小时
		  </td>
      </tr>
	  <tr>
        ...
        <td>
          <input name="xb" type="text" size="30" class="input" datatype="int" 
		             value="<c:out value="${todo.xb}"/>" nullable="no" maxsize="3" chname="b"> 小时
		  </td>
      </tr>
     ...
     <td>
      ...
      <tr>
        ...
        <td align="left" valign="bottom" height="30">&nbsp;
              <br><input name="btn_save2" type="submit" value="保存" class="button"></td>
      </tr>
    </table>
	</td>
  </tr>
