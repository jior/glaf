...
insert into sys_tree (id, parent, name, nodeDesc, code, sort) values (9, 8, '基础数据', '基础数据', '', 430);
insert into sys_tree (id, parent, name, nodedesc, sort, code) values (10, 8, '权限管理', '权限管理', 30, '');
...
insert into sys_tree (id, parent, name, nodeDesc, sort, code) values (16, 9, '字典管理', '字典管理', 20, '');
insert into sys_tree (id, parent, name, nodeDesc, sort, code) values (26, 9, '数据重载', '数据重载', 26, '');
...
insert into sys_tree (id, parent, name, nodedesc, sort, code) values (434, 8, '流程管理', '流程管理', 434, '');
...
insert into sys_application (id, name, appdesc, url, sort, showmenu, nodeid) values (10, '权限管理', '', '', 14, 2, 10);
