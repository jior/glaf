...
CREATE TABLE SYS_USER_ONLINE (
        ...
        CHECKDATE_ TIMESTAMP(6),
        CHECKDATEMS_ NUMBER(19),
        LOGINDATE_ TIMESTAMP(6),
        LOGINIP_ NVARCHAR2(100),
        NAME_ NVARCHAR2(50),
        SESSIONID_ NVARCHAR2(200),
        PRIMARY KEY (ID_)
    );
...
CREATE TABLE SYS_ROLE(
        ID NUMBER(19) NOT NULL,
        NAME NVARCHAR2(255),
        ROLEDESC NVARCHAR2(500),
        CODE NVARCHAR2(255),
	TYPE NVARCHAR2(50),
	ISUSEBRANCH NVARCHAR2(10),
        SORT INTEGER,
        PRIMARY KEY (ID)
);
...
CREATE TABLE SYS_USER (
	...
	LASTCHANGEPASSWORDDATE TIMESTAMP(6),
        PRIMARY KEY (ID)
);
...
CREATE TABLE SYS_TODO_INSTANCE(
  ...
  CREATE TABLE SYS_SCHEDULER (
	...
	JOBRUNTIME NUMBER(19),
        NEXTFIRETIME TIMESTAMP(6),
        PREVIOUSFIRETIME TIMESTAMP(6),
        RUNSTATUS INTEGER,
        RUNTYPE INTEGER,
        PRIMARY KEY (ID)
    );
