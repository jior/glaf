...
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (1, 0, 'code', 'CODE', '编码', 'String', 50, 0, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (2, 0, 'dictdesc', 'DICTDESC', '描述', 'String', 200, 1, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (3, 0, 'value', 'VALUE_', '值', 'String', 2000, 2, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (4, 0, 'ext1', 'EXT1', '扩展字段1', 'String', 200, 3, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (5, 0, 'ext2', 'EXT2', '扩展字段2', 'String', 200, 4, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (6, 0, 'ext3', 'EXT3', '扩展字段3', 'String', 200, 5, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (7, 0, 'ext4', 'EXT4', '扩展字段4', 'String', 200, 5, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (8, 0, 'ext5', 'EXT5', '扩展字段5', 'Date', 0, 7, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (9, 0, 'ext6', 'EXT6', '扩展字段6', 'Date', 0, 8, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (10, 0, 'ext7', 'EXT7', '扩展字段7', 'String', 2000, 9, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (11, 0, 'ext8', 'EXT8', '扩展字段8', 'String', 2000, 10, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (12, 0, 'ext9', 'EXT9', '扩展字段9', 'Long', 0, 11, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (13, 0, 'ext10', 'EXT10', '扩展字段10', 'Long', 0, 12, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (14, 0, 'ext11', 'EXT11', '扩展字段11', 'Double', 0, 13, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (15, 0, 'ext12', 'EXT12', '扩展字段12', 'Double', 0, 14, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (16, 0, 'ext13', 'EXT13', '扩展字段13', 'Double', 0, 15, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (17, 0, 'ext14', 'EXT14', '扩展字段14', 'Double', 0, 16, 0, 'dictory');
insert into sys_dictory_def (id, nodeid, name, columnname, title, type, length, sort, required, target) values (18, 0, 'ext15', 'EXT15', '扩展字段15', 'Double', 0, 17, 0, 'dictory');
...
insert into sys_property (id_, description_, locked_, name_, title_, type_, value_, category_, initvalue_) values ('3', '版权信息', 0, 'res_copyright', '版权信息', null, 'XX科技 版权所有', 'SYS', null);
