...
public class Authentication {
	...
	static ThreadLocal<String> authenticatedAccountThreadLocal = new ThreadLocal<String>();

	static ThreadLocal<SysUser> authenticatedUserThreadLocal = new ThreadLocal<SysUser>();
