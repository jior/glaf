...
import com.glaf.base.modules.sys.model.ExchangeRateHistory;
...
public class DictoryService {
	 ...
	 * @return
	 */
	public boolean createExchangeRateHistory(ExchangeRateHistory bean){
		logger.info("create ExchangeRateHistory");
	 ...
	 * @return
	 */
	public List getDictoryList(long parent){
		Object[] values=new Object[]{new Long(parent)};
	 ...
	 * @return
	 */
	public List getAvailableDictoryList(long parent){
		Object[] values=new Object[]{new Long(parent)};
	 ...
	 * updateDate:2010-7-30
	 * @param list
	 * @param purchaseId
	 * @return
	 */
	public Map getDictoryMap(List list,long purchaseId){
