...
public class WorkCalendarServiceImpl implements WorkCalendarService {
	private static final Log logger = LogFactory.getLog(WorkCalendarServiceImpl.class);
	...
	public WorkCalendar findById(long id){
		return (WorkCalendar) abstractDao.find(WorkCalendar.class, new Long(id));
	}
	/**
	 * 获取对象
	 * 
	...
	public WorkCalendar find(int year, int month, int day) {
		...
		Object[] values = new Object[] { new Integer(year), new Integer(month), new Integer(day) };
