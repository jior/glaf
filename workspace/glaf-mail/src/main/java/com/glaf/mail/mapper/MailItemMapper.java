...
public interface MailItemMapper {
	...
	void deleteMailItems(MailItemQuery query);

	MailItem getMailItemById(MailItemQuery query);

	int getMailItemCount(MailItemQuery query);
	...
	void insertMailItem(MailItem model);

	void updateMailItem(MailItem model);
