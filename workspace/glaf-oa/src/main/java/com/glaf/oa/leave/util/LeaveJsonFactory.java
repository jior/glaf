 ...
 */
package com.glaf.oa.leave.util;
...
public class LeaveJsonFactory {

	public static Leave jsonToObject(JSONObject jsonObject) {
		Leave model = new Leave();
		if (jsonObject.containsKey("leaveid")) {
			model.setLeaveid(jsonObject.getLong("leaveid"));
		}
		...
		if (jsonObject.containsKey("leavesum")) {
			model.setLeavesum(jsonObject.getDouble("leavesum"));
		}
	...
	public static JSONObject toJsonObject(Leave model) {
		JSONObject jsonObject = new JSONObject();
		jsonObject.put("leaveid", model.getLeaveid());
		jsonObject.put("_leaveid_", model.getLeaveid());
		jsonObject.put("_oleaveid_", model.getLeaveid());
		...
		jsonObject.put("leavesum", model.getLeavesum());
	...
	public static ObjectNode toObjectNode(Leave model) {
	...
	public static JSONArray listToArray(java.util.List<Leave> list) {
		JSONArray array = new JSONArray();
		if (list != null && !list.isEmpty()) {
			for (Leave model : list) {
