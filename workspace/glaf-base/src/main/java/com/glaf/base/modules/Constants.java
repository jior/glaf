...
public class Constants {
	...
	public static final String TREE_APP = "02";// 模块结构树编号
	public static final String TREE_BASE = "01";// 基础数据结构树编号
	public static final String TREE_DEPT = "012";// 部门结构树编号
	public static final String TREE_DICTORY = "011";// 数据字典结构树编号

	public static final int TREE_ROOT = 1;// 目录根节点
