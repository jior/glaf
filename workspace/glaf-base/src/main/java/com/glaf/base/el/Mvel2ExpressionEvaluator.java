...
public class Mvel2ExpressionEvaluator {
	...
	public static void main(String[] args) throws Exception {
		...
		context.put("a", Integer.valueOf(123));
		context.put("b", Integer.valueOf(789));
		expression = "${ a + b }";
		...
		context.put("c", Double.valueOf(123));
		context.put("d", Double.valueOf(789));
		expression = "${ c / d }";
