...
public interface SysFunctionMapper {
	...
	void deleteSysFunctions(SysFunctionQuery query);

	void deleteSysFunctionById(Long id);

	SysFunction getSysFunctionById(Long id);

	int getSysFunctionCount(SysFunctionQuery query);
	...
	void updateSysFunction(SysFunction model);
