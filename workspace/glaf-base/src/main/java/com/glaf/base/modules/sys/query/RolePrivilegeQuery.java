...
public class RolePrivilegeQuery extends DataQuery {
	...
	public RolePrivilegeQuery appId(Long appId) {
		if (appId == null) {
	...
	public RolePrivilegeQuery appIds(List<Long> appIds) {
		if (appIds == null) {
	...
	public RolePrivilegeQuery roleIds(List<Long> roleIds) {
		if (roleIds == null) {
