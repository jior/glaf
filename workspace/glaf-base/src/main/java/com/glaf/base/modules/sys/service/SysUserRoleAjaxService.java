...
public class SysUserRoleAjaxService {
	...
	public boolean addRole(long fromUserId, long toUserId, String startDate,
		...
		return sysUserRoleService.addRole(fromUserId, toUserId, startDate,
	 ...
	 * @return booelan
	 */
	public boolean addRoleUser(long fromUserId, String toUserIds,
		...
		for (int i = 0; i < ids.length; i++) {
			...
			addRole(fromUserId, toUserId, startDate, endDate, mark,
					processNames, processDescriptions);
		}
		return true;
	}
