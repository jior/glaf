...
public class ZKClientSessionHandlerValve extends ValveBase {
	private final Log log = LogFactory
			.getLog(ZKClientSessionHandlerValve.class);
	private ZKClientSessionManager manager;
	...
	public void setZKClientSessionManager(ZKClientSessionManager manager) {
