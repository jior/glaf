...
public class CuratorSessionHandlerValve extends ValveBase {
	private final Log log = LogFactory.getLog(CuratorSessionHandlerValve.class);
	private CuratorSessionManager manager;
	...
	public void setCuratorSessionManager(CuratorSessionManager manager) {
