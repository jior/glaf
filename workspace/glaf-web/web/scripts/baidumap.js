function baidu_map(data) {
    ...
    if (data) {
        ...
        var point = new BMap.Point(113.372508, 23.134507);
        doit(point);
    ...
    function doit(point) {
        ...
        if (point) {
            ...
            document.getElementById('latitude').value = point.lat;//纬度latitude
            document.getElementById('longitude').value = point.lng;//经度longitude
            map.setCenter(point);
            ...
            myGeo.getLocation(point, function (result) {
                if (result) {
                    document.getElementById('label').value = result.address;
                }
            });
    ...
    function loadMap() {
        ...
        var city = document.getElementById('label').value;
