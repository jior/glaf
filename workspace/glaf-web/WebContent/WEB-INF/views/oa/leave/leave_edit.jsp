...
<script type="text/javascript">
	...
	function saveData() {
		...
		jQuery.ajax({
			type : "POST",
			url : '${contextPath}/mx/oa/leave/saveLeave',
			data : params,
			dataType : 'json',
			error : function(data) {
				alert('服务器处理错误！');
	...
	<div class="easyui-layout" data-options="fit:true">
		<div data-options="region:'north',split:true,border:true"
			...
			<div class="toolbar-backgroud">
				<span class="x_content_title">请假申请</span> <a href="#"
					...
					<tbody>
						...
						<tr>
							...
							<td align="left"><input id="appuser" class="easyui-combobox"
								name="appuser" value="${leave.appuser}"
				...
				onSelect: function(rec){ 
						...
						<tr>
							...
							<td align="left"><input id="type" class="easyui-combobox"
								name="type" value="${leave.type}" editable="false"
						...
						<tr>
							<td width="20%" align="left">请假时间：</td>
						...
						<tr>
							...
							<td align="left" colspan="5"><a
								href="javascript:uploadFile(13, ${leave.leaveid}, 1)">附件上传 <img
									src="${contextPath}/images/folder3_document.png" border="0"></a>
								(共<span id="numAttachment13" name="numAttachment13">0</span>个) <script
									type="text/javascript">
									jQuery(function() {
										jQuery
												.get(
														'${contextPath}/others/attachment.do?method=getCount&referId=${leave.leaveid}&referType=13',
														{
															qq : 'xx'
														},
														function(data) {
															document
																	.getElementById("numAttachment13").innerHTML = data.message;
														}, 'json');
									});
								</script></td>
						</tr>
