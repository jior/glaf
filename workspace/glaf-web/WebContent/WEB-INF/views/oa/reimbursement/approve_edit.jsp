...
<script type="text/javascript">
	...
	function passData() {
		if (confirm("确认审核通过吗？")) {
			var reimbursementids = jQuery('#reimbursementid').val();
		...
		<div data-options="region:'center',border:false,cache:true">
			<form id="iForm" name="iForm" method="post">
				...
				<table style="width: 780px;">
					<tbody>
						<tr>
							<td align="left" width="55px;"><div style="width: 45px;">申请人</div></td>
							<td align="left"><input id="appuser" class="easyui-combobox"
								name="appuser" value="${reimbursement.appuser}" size="12"
								disabled="disabled"
