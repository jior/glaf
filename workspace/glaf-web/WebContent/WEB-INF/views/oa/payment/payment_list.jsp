...
<script type="text/javascript">
	...
	jQuery(function() {
		jQuery('#mydatagrid').datagrid({
			...
			striped : true,
			collapsible : true,
			url : '${contextPath}/mx/oa/payment/json?rstatus=' + rstatus,
			sortName : 'id',
			sortOrder : 'desc',
			remoteSort : false,
			singleSelect : true,
	...
	function addNew() {
		var link = "${contextPath}/mx/oa/payment/edit";
	...
	function editSelected() {
		...
		if (selected) {
			var link = "${contextPath}/mx/oa/payment/edit?paymentid="
					+ selected.id;
			art.dialog.open(link, {
				height : 430,
				width : 900,
		...
		<div data-options="region:'north',split:true,border:true"
			...
			<div class="toolbar-backgroud">
				<img src="${contextPath}/images/window.png"> &nbsp; <span
					class="x_content_title">付款申请列表</span> <a href="#"
