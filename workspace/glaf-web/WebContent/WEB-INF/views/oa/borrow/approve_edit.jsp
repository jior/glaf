...
<script type="text/javascript">
	...
	function reback() {
		location.href = "${contextPath}/mx/oa/borrowApprove";
	}
	...
	function passData() {
		if (confirm("确认审核通过吗？")) {
			var borrowids = jQuery('#borrowid').val();
	...
	<div class="easyui-layout" data-options="fit:true" align="center"
		...
		<div data-options="region:'north',split:true,border:true"
			...
			<div class="toolbar-backgroud" align="left">
				<span class="x_content_title">员工借支申请审核</span> <a href="#"
				...
				<table style="width: 680px;" align="center" cellspacing="4">
					...
					" />
							...
							<td align="left"><input id="post" name="post" type="text"
								disabled="disabled" class="easyui-validatebox" size="20"
