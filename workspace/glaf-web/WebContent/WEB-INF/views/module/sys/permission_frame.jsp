          ...
          <tr> 
            <td width="100" height="45" valign="bottom"><table width="100%" height="100%"  border="0" align="right" cellpadding="0" cellspacing="0">
                <tr> 
                  ...
                  <td><span class="style2">权限管理</span></td>
                </tr>
              </table></td>
        ...
        <jsp:param name="parent" value="<%=parent%>"/>     
          ...
          <tr> 
            <td colspan="4" valign="top" class="tdborder"> <table width="100%" height="100%"  border="0" cellpadding="0" cellspacing="0">
                <tr> 
                  <td><iframe id="mainFrame" name="mainFrame" src="department.do?method=showFrame" width="100%" frameborder="0" height="370"></iframe></td>
                </tr>
              </table></td>
          </tr>
        </table>
