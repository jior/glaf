...
<%
		...
		if(rows != null && rows.size()> 0){
				  ...
				  while(iterator008.hasNext()){
					   ...
					   ToDoInstance xx = (ToDoInstance)dataMap.get(new Long(tdi.getRoleId()));
					   if(xx == null){
						   xx = new ToDoInstance();
						   xx.setRoleId(tdi.getRoleId());
						   SysRole r = (SysRole)roleMap.get(new Long(tdi.getRoleId()));
						   if(r != null){
							   xx.setRoleName(r.getName());
						   }
					   }
					   ...
					   dataMap.put(new Long(tdi.getRoleId()), xx);
        ...
        while(iter003.hasNext()){
			...
			if(tdi.getRoleName() != null){
			    String title = "["+tdi.getRoleId()+"]" + tdi.getRoleName()  ;
		...
		String dataFile ="role_stackedbar";
