...
<%
	MyMenu bean = (MyMenu) request.getAttribute("bean");
%>
<html>
<head>
...
<body>
<div class="nav-title"><span class="Title">工作台</span>&gt;&gt; 修改我的菜单</div>
<html:form action="/workspace/mymenu.do?method=saveModify" method="post" onsubmit="return verifyAll(this);" >
    ...
    <tr>
      <td class="box-mm"><table width="95%" border="0" align="center" cellpadding="5" cellspacing="0">
        <tr>
          ...
          <td><input name="title" type="text" class="input" size="45" value="<%= bean.getTitle() %>" datatype="string" nullable="no" maxsize="100" chname="菜单标题"></td>
        </tr>
        <tr>
          <td class="input-box">访问链接*</td>
          <td><input name="url" type="text" class="input" value="<%= URLDecoder.decode(bean.getUrl()) %>" size="45" datatype="string" nullable="no" maxsize="200" chname="访问链接"></td>
        </tr>
      </table>
