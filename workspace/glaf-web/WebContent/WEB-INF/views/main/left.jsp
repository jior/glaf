...
<div id="main">
  <ul class="container">
      <li class="menu">
          <ul>
		    <li class="button">
		    	<a name="lightbutton" onClick="window.parent.frames['mainFrame'].location.href='<%=request.getContextPath()%>/main.do?method=main';changeClassButton(this);" href="#" class="red">首页 </a>
		    </li>   
          </ul>
      </li>
      <%=scripts%>
