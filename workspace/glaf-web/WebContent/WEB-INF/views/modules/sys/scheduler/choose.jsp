...
<script type="text/javascript" src="<%=request.getContextPath()%>/scripts/cron.js"></script>
<style type="text/css">
    .line {
        height: 25px;
        line-height: 25px;
...
<div class="easyui-layout" 
     style="width:830px;height:460px; border: 1px rgb(202, 196, 196) solid;
      border-radius: 5px;">
