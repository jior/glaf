...
<html:form action="${contextPath}/sys/function.do?method=batchDelete" method="post" target="_self"> 
...
<html:form action="${contextPath}/sys/function.do?method=saveAdd" method="post" target="hiddenFrame" onsubmit="return verifyAll(this);" > 
<input type="hidden" name="parent" value="<%=parent%>">
