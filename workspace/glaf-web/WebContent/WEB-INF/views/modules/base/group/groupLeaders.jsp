...
<script type="text/javascript">
    ...
    var setting = {
			async: {
				enable: true,
				url: "<%=request.getContextPath()%>/rs/base/group/jsonLeader?groupId=${groupId}"
			},
			check: {
				enable: true
			}
	...
	function saveMyFormData(){
		...
		jQuery.ajax({
				   type: "POST",
				   url: '<%=request.getContextPath()%>/base/group.do?method=saveGroupLeaders',
				   data: params,
				   dataType:  'json',
				   error: function(data){
					   alert('服务器处理错误！');
...
<div class="easyui-layout" data-options="fit:true">  
  <div data-options="region:'north',split:true,border:true" style="height:40px"> 
	...
	<span class="x_content_title">群组领导设置</span>
