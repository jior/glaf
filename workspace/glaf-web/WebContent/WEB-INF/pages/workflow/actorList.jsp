...
<br><br>
<div align="center"><b>人员列表</b></div><br>
<table align="center" class="table-border" cellspacing="1" cellpadding="4" width="80%" nowrap>
    ...
    <tr class="beta">
	  <td width="25%" height="15" align="left"><c:out value="${user.actorId}"/></td>
	  <td width="25%" height="15" align="left"><c:out value="${user.name}"/></td>
	  <td width="25%" height="15" align="left"><c:out value="${user.mail}"/></td>
	  <td width="25%" height="15" align="left"><c:out value="${user.mobile}"/></td>
    </tr>
    </c:forEach>
   </table>
