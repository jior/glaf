...
function refreshUploadStatus(){
	...
	ajaxW.putRequest(
		...
		function(responseText){
				...
				//$('progressStatusText').innerHTML=' 反馈状�1�7�1�7123 '+uploadInfo.Status + "|||";
...
function startProgress(){
    ...
    //$('progressStatusText').innerHTML=' 反馈状�1�7�1�7';
...
function cancelProgress(){
	...
	ajaxW.putRequest(
		'./BackGroundService.action',
		'cancelUpload=true',
		//因为form的提交，这可能不会执衄1�7

		function(responseText){
			eval("uploadInfo = " + responseText);
			//$('progressStatusText').innerHTML=' 反馈状�1�7�1�7 '+uploadInfo.status;
