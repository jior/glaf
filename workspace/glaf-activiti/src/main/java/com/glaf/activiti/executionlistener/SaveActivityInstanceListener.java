...
public class SaveActivityInstanceListener implements ExecutionListener {
	private static final long serialVersionUID = 1L;
	
	protected final static Log logger = LogFactory
			.getLog(SaveActivityInstanceListener.class);

	public void notify(DelegateExecution execution) throws Exception {
		logger.debug("--------------------------------------------------------");
		logger.debug("--------------SaveActivityInstanceListener--------------");
		logger.debug("--------------------------------------------------------");
		...
		if (variables != null) {
			activityInstance
					.setApprove(variables.get("approve") != null ? variables
							.get("approve") + "" : "");
		...
		activityInstance.setEventName(execution.getEventName());
