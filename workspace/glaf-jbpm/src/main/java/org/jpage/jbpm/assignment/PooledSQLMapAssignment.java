 ...
 * 
 */
public class PooledSQLMapAssignment implements AssignmentHandler {
	private static final Log logger = LogFactory
			.getLog(PooledSQLMapAssignment.class);
	...
	public void assign(Assignable assignable, ExecutionContext ctx) {
		logger.debug("-------------------------------------------------------");
		logger.debug("----------------PooledSQLMapAssignment-----------------");
		logger.debug("-------------------------------------------------------");
		...
		if (task != null) {
			...
			if (StringUtils.isNotBlank(queryId)) {
				...
				Collection actors = MutableSQLMapContainer.getContainer()
