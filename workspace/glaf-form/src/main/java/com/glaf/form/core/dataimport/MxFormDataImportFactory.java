...
public class MxFormDataImportFactory {
	protected static final Log logger = LogFactory
			.getLog(MxFormDataImportFactory.class);
	 ...
	 * @return
	 */
	public static MxFormDataImport getDataImport(String templateType) {
		MxFormDataImport dataImport = (MxFormDataImport) getBean(templateType);
		return dataImport;
	}
	...
	public static FormDefinitionType read(String templateType, byte[] bytes) {
		...
		MxFormDataImport dataImport = getDataImport(templateType);
