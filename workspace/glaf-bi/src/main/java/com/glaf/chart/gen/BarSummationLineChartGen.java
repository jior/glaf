...
public class BarSummationLineChartGen implements ChartGen {
	protected static final Log logger = LogFactory
			.getLog(BarSummationLineChartGen.class);

	public static void main(String[] paramArrayOfString) {
		BarSummationLineChartGen chartDemo = new BarSummationLineChartGen();
		...
		chartModel.setChartName("bar_line_sum");
		chartModel.setChartType("bar_line_sum");
	...
	public JFreeChart createChart(Chart chartModel) {
		logger.debug("------------BarSummationLineChartGen.createChart-----------------");
