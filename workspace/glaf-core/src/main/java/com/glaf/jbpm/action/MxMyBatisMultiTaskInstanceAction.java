 ...
 * </task-node><br>
 */
public class MxMyBatisMultiTaskInstanceAction implements ActionHandler {
	private static final Log logger = LogFactory
			.getLog(MxMyBatisMultiTaskInstanceAction.class);
	...
	public MxMyBatisMultiTaskInstanceAction() {
