 ...
 * {@link com.ibatis.sqlmap.client.SqlMapExecutor}'s execution methods. Users
...
public interface SqlMapClientOperations {
	...
	/**
	 * @see com.ibatis.sqlmap.client.SqlMapExecutor#queryForList(String, int,
	 *      int)
	 * @throws org.springframework.dao.DataAccessException
	 *             in case of errors
	 */
	List<Object> queryForList(String statementName, int skipResults,
	...
	/**
	 * @see com.ibatis.sqlmap.client.SqlMapExecutor#queryWithRowHandler(String,
	 *      RowHandler)
	 * @throws org.springframework.dao.DataAccessException
	 *             in case of errors
	 */
	 ...
	 *             in case of errors
	 */
	Map<Object, Object> queryForMap(String statementName,
