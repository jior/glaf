...
public class MxMultiPooledTaskInstanceAction implements ActionHandler {
	private static final Log logger = LogFactory
			.getLog(MxMultiPooledTaskInstanceAction.class);
	...
	public MxMultiPooledTaskInstanceAction() {
