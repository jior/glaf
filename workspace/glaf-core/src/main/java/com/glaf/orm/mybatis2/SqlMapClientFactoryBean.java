 ...
 * @see SqlMapClientTemplate#setDataSource as of Spring 3.2, in favor of the
 *      native Spring support in the Mybatis follow-up project
...
public class SqlMapClientFactoryBean implements FactoryBean<SqlMapClient>,
	 ...
	 * 
	 * @see #setLobHandler
	 * @see com.glaf.orm.mybatis2.support.ClobStringTypeHandler
	 * @see com.glaf.orm.mybatis2.support.BlobByteArrayTypeHandler
	 * @see com.glaf.orm.mybatis2.support.BlobSerializableTypeHandler
	 */
	 ...
	 * @see com.ibatis.sqlmap.engine.transaction.jta.JtaTransactionConfig
	 */
	public void setTransactionConfigProperties(
			Properties transactionConfigProperties) {
