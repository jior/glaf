 ...
 * 
 */
public class HibernatePersistenceDAO extends HibernateDaoSupport implements
		PersistenceDAO {
	private static final Log logger = LogFactory
			.getLog(HibernatePersistenceDAO.class);
	...
	public HibernatePersistenceDAO() {
		logger.info("HibernatePersistenceDAO init");
	}
