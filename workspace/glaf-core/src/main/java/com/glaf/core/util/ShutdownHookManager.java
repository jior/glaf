...
public class ShutdownHookManager {
	...
	private Set<HookEntry> hooks = Collections
	...
	/**
	 * Adds a shutdownHook with a priority, the higher the priority the earlier
	 * will run. ShutdownHooks with same priority run in a non-deterministic
	 * order.
	 *
	 * @param shutdownHook
