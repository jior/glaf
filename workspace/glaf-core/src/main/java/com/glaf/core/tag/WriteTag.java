...
public class WriteTag extends TagSupport {
	 ...
	 * resources.
	 */
	public static final String INT_FORMAT_KEY = "com.glaf.core.tag.format.int";

	/**
	 * The key to search default format string for float (double, BigDecimal) in
	 * resources.
	 */
	public static final String FLOAT_FORMAT_KEY = "com.glaf.core.tag.format.float";
	 ...
	 * patterns, see
	 * <http://www.dei.unipd.it/corsi/fi2ae-docs/source/jdk1.1.7/src
	 * /java/text/resources/>. (To obtain the correct value for some characters,
	 * you may need to view the file in a hex editor and then use the Unicode
	 * escape form in the property resources file.)
	 * 
	 * @param valueToFormat
