...
package com.glaf.core.mail.web.rest;
...
@Controller("/rs/mail/receive")
@Path("/rs/mail/receive")
public class MailReceiveReource {

	protected static Log logger = LogFactory.getLog(MailReceiveReource.class);
	...
	@POST
	@Path("/view")
	public void view(@Context HttpServletRequest request,
