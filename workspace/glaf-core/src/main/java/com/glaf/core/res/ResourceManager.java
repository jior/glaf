 ...
 * 
 * <p>
 * The ResourceManager operates on a package basis. One ResourceManager per
 * package can be created and accessed via the getManager method call.
 * 
 * <p>
 * The ResourceManager will look for a ResourceBundle named by the package name
 ...
 * information.
 * 
 * @version $Id: ResourceManager.java 1200166 2011-11-10 05:50:36Z kkolinko $
 * 
...
public class ResourceManager {
	...
	/**
	 * Creates a new ResourceManager for a given package. This is a private
	 * method and all access to it is arbitrated by the static getManager method
	 * call so that only one ResourceManager per package will be created.
	 * 
	 * @param packageName
	 *            Name of package to create ResourceManager for.
	 */
	private ResourceManager(String packageName, Locale locale) {
	...
	/**
	 * Identify the Locale this ResourceManager is associated with
	 */
	...
	private static final Map<String, Map<Locale, ResourceManager>> managers = new Hashtable<String, Map<Locale, ResourceManager>>();
	...
	/**
	 * Get the ResourceManager for a particular package and Locale. If a manager
	 * for a package/Locale combination already exists, it will be reused, else
	 * a new ResourceManager will be created and returned.
	 * 
	 * @param packageName
	 *            The package name
	 * @param locale
