...
import com.glaf.core.io.compress.snappy.LoadSnappy;
import com.glaf.core.io.compress.snappy.SnappyCompressor;
import com.glaf.core.io.compress.snappy.SnappyDecompressor;
...
public class SnappyCodec implements CompressionCodec {
	...
	public static boolean isNativeSnappyLoaded(Configuration conf) {
		return LoadSnappy.isLoaded()
				&& conf.getBoolean(Constants.IO_NATIVE_LIB_AVAILABLE_KEY,
						Constants.IO_NATIVE_LIB_AVAILABLE_DEFAULT);
	}
	...
	public CompressionOutputStream createOutputStream(OutputStream out,
		...
		int bufferSize = conf.getInt(
				Constants.IO_COMPRESSION_CODEC_SNAPPY_BUFFERSIZE_KEY,
				Constants.IO_COMPRESSION_CODEC_SNAPPY_BUFFERSIZE_DEFAULT);
