/*
 * $Id: ViewMessage.java 471754 2006-11-06 14:55:09Z husted $
 *
...
public class ViewMessage implements Serializable {
     ...
     */
    public ViewMessage(String key, Object value0) {
     ...
     */
    public ViewMessage(String key, Object value0, Object value1) {
     ...
     */
    public ViewMessage(String key, Object value0, Object value1, Object value2) {
     ...
     */
    public ViewMessage(String key, Object[] values) {
        this.key = key;
        this.values = values;
        this.resource = true;
    }
     ...
     *                 value
     */
    public ViewMessage(String key, boolean resource) {
        this.key = key;
