...
/**
 * A {@link com.glaf.core.io.compress.CompressorStream} which works with
 * 'block-based' based compression algorithms, as opposed to 'stream-based'
 * compression algorithms.
 * 
 * It should be noted that this wrapper does not guarantee that blocks will be
 * sized for the compressor. If the
 * {@link com.glaf.core.io.compress.Compressor} requires buffering to effect
 * meaningful compression, it is responsible for it.
 */
public class BlockCompressorStream extends CompressorStream {
	 ...
	 * @param bufferSize
	 *            size of buffer
	 * @param compressionOverhead
	 *            maximum 'overhead' of the compression algorithm with given
	 *            bufferSize
	 */
	 ...
	 * compressor. Use default of 512 as bufferSize and compressionOverhead of
