...
public class Hex {
	...
	private static final Constructor<String> stringConstructor = getProtectedConstructor(
			String.class, int.class, int.class, char[].class);
	 ...
	 *         accessed
	 */
	public static Constructor<String> getProtectedConstructor(
			Class<String> klass, Class<?>... paramTypes) {
