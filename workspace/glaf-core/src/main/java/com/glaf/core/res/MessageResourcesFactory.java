...
import com.glaf.core.tag.ResponseUtils;
...
public abstract class MessageResourcesFactory implements Serializable {
	 ...
	 */
	protected static String factoryClass = "com.glaf.core.res.PropertyMessageResourcesFactory";
	...
	public static MessageResourcesFactory createFactory() {
		...
		try {
			if (clazz == null) {
				clazz = ResponseUtils.applicationClass(factoryClass);
			}
