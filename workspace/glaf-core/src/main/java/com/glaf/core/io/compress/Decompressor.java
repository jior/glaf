 ...
 * {@link CompressionInputStream} to compress data. This is modelled after
...
public interface Decompressor {
	...
	/**
	 * Sets preset dictionary for compression. A preset dictionary is used when
	 * the history buffer can be predetermined.
	 * 
	 * @param b
	...
	/**
	 * Returns <code>true</code> if a preset dictionary is needed for
	 * decompression.
	 * 
	 * @return <code>true</code> if a preset dictionary is needed for
	 *         decompression
	 */
	 ...
	 * typically called after the decompressor has finished decompressing the
	 * current gzip stream (a.k.a. "member").
	 */
