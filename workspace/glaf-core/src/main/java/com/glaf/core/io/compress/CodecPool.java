...
public class CodecPool {
	 ...
	 * @param conf
	 *            the <code>Configuration</code> object which contains confs for
	...
	public static Compressor getCompressor(CompressionCodec codec,
			Configuration conf) {
		Compressor compressor = borrow(compressorPool,
	...
	public static Decompressor getDecompressor(CompressionCodec codec) {
		Decompressor decompressor = borrow(decompressorPool,
