...
import com.glaf.core.io.compress.bzip2.BZip2DummyCompressor;
import com.glaf.core.io.compress.bzip2.BZip2DummyDecompressor;
import com.glaf.core.io.compress.bzip2.CBZip2InputStream;
import com.glaf.core.io.compress.bzip2.CBZip2OutputStream;
...
public class BZip2Codec implements
		com.glaf.core.io.compress.CompressionCodec {
	 ...
	 *             Throws UnsupportedOperationException
	 */
	public Class<? extends com.glaf.core.io.compress.Compressor> getCompressorType() {
	 ...
	 *             Throws UnsupportedOperationException
	 */
	public Class<? extends com.glaf.core.io.compress.Decompressor> getDecompressorType() {
	...
	private static class BZip2CompressionOutputStream extends
		...
		public void finish() throws IOException {
			if (needsReset) {
				// In the case that nothing is written to this stream, we still
				// need to
				// write out the header before closing, otherwise the stream
				// won't be
